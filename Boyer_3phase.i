...
[Materials]
  ...
  [./S_T]
    type = ParsedMaterial
    f_name = S_T
    material_property_names = 'Sfac_L Sfac_V Sfac_S'
    function = '-3 * Sfac_L * Sfac_V * Sfac_S/(Sfac_L*Sfac_V+Sfac_L*Sfac_S+Sfac_V*Sfac_S)'
  [../]
  ...
  [./eps_Sig_S]
    type = ParsedMaterial
    f_name = eps_Sig_S
    material_property_names = 'e Sfac_S'
    function = '-(3/4) * e * Sfac_S'
  [../]
[]
