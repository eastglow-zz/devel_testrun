...
[Materials]
  [./constants]
    ...
    prop_values = '1     1      1      1 1   -1     0'
    # prop_values = '4     2    4      1 1   -1     0'
    # prop_values = '1     0.134  1      1 1   -1     0'
  [../]
  ...
  [./doublewell_f0]
    ...
    args = 'cL cV cS'
    function = 'fLV + fLS + fVS - 6*cL*cV*cS*(Sfac_L*cL + Sfac_V*cV + Sfac_S*cS)'
    # function = 'fLV + fLS + fVS'
  [../]
