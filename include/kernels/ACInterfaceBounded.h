...
#ifndef ACINTERFACEBOUNDED_H
#define ACINTERFACEBOUNDED_H

#include "Kernel.h"
#include "JvarMapInterface.h"
#include "DerivativeMaterialInterface.h"

class ACInterfaceBounded;

template <>
InputParameters validParams<ACInterfaceBounded>();

/**
 * Compute the Allen-Cahn interface term with the weak form residual
 * \f$ \left( \kappa_i \nabla\eta_i, \nabla (L_i \psi) \right) \f$
 */
class ACInterfaceBounded : public DerivativeMaterialInterface<JvarMapKernelInterface<Kernel>>
{
public:
  ACInterfaceBounded(const InputParameters & parameters);
