...
#ifndef ANISOTROPICGRADENERGYNOBC_H
#define ANISOTROPICGRADENERGYNOBC_H

#include "Kernel.h"
#include "JvarMapInterface.h"
#include "DerivativeMaterialInterface.h"

class AnisotropicGradEnergyNoBC;

template <>
InputParameters validParams<AnisotropicGradEnergyNoBC>();

class AnisotropicGradEnergyNoBC : public DerivativeMaterialInterface<JvarMapKernelInterface<Kernel>>
{
public:
  AnisotropicGradEnergyNoBC(const InputParameters & parameters);
...
#endif // ANISOTROPICGRADENERGYNOBC_H
