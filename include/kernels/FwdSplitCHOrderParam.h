...
#ifndef FWDSPLITCHORDERPARAM_H
#define FWDSPLITCHORDERPARAM_H

#include "Kernel.h"
#include "DerivativeMaterialInterface.h"

class FwdSplitCHOrderParam;

template <>
InputParameters validParams<FwdSplitCHOrderParam>();

class FwdSplitCHOrderParam : public DerivativeMaterialInterface<Kernel>
{
public:
  FwdSplitCHOrderParam(const InputParameters & parameters);
