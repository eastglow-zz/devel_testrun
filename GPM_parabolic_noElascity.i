...
# Order parameter eta_m0 for matrix grain 0
  [./ACm0_bulk]
    type = ACGrGrMulti
    variable = etam0
    v =           'bubble etam1 etam2 etam3 etam4'
  ...
  [./ACm0_sw]
    ...
    Fj_names  = 'omegab   omegam'
    hj_names  = 'hb       hm'
    args = 'bubble etam1 etam2 etam3 etam4 wv wg'
    mob_name = L
  [../]
  [./ACm0_int]
    type = ACInterface
...
# Order parameter eta_m1 for matrix grain 1
  [./ACm1_bulk]
    type = ACGrGrMulti
    variable = etam1
    v =           'bubble etam0 etam2 etam3 etam4'
    gamma_names = 'gmb   gmm   gmm   gmm   gmm'
    mob_name = L
  [../]
  [./ACm1_sw]
    ...
    Fj_names  = 'omegab   omegam'
    hj_names  = 'hb       hm'
    args = 'bubble etam0 etam2 etam3 etam4 wv wg'
    mob_name = L
  [../]
  [./ACm1_int]
    type = ACInterface
  ...
  # Order parameter eta_m1 for matrix grain 2
    [./ACm2_bulk]
      type = ACGrGrMulti
      variable = etam2
      v =           'bubble etam0 etam1 etam3 etam4'
      gamma_names = 'gmb   gmm   gmm   gmm   gmm'
      mob_name = L
    [../]
    [./ACm2_sw]
      ...
      Fj_names  = 'omegab   omegam'
      hj_names  = 'hb       hm'
      args = 'bubble etam0 etam1 etam3 etam4 wv wg'
      mob_name = L
    [../]
    [./ACm2_int]
      type = ACInterface
  ...
  # Order parameter eta_m3 for matrix grain 3
    [./ACm3_bulk]
      type = ACGrGrMulti
      variable = etam3
      v =           'bubble etam0 etam1 etam2 etam4'
      gamma_names = 'gmb   gmm   gmm   gmm   gmm'
      mob_name = L
    [../]
    [./ACm3_sw]
      ...
      Fj_names  = 'omegab   omegam'
      hj_names  = 'hb                   hm'
      args = 'bubble etam0 etam1 etam2 etam4 wv wg'
      mob_name = L
    [../]
    [./ACm3_int]
      type = ACInterface
  ...
  # Order parameter eta_m4 for matrix grain 4
    [./ACm4_bulk]
      type = ACGrGrMulti
      variable = etam4
      v =           'bubble etam0 etam1 etam2 etam3'
      gamma_names = 'gmb   gmm   gmm   gmm   gmm'
      mob_name = L
    [../]
    [./ACm4_sw]
      ...
      Fj_names  = 'omegab   omegam'
      hj_names  = 'hb                   hm'
      args = 'bubble etam0 etam1 etam2 etam3 wv wg'
      mob_name = L
    [../]
    [./ACm4_int]
      type = ACInterface
...
#Chemical potential for vacancies
  ...
  [./coupled_v_bubbledot]
    ...
    hj_names = 'hb      hm'
    args = 'bubble etam0 etam1 etam2 etam3 etam4'
  [../]
  [./coupled_v_etam0dot]
    type = CoupledSwitchingTimeDerivative
    variable = wv
