...
#include "ACInterfaceBounded.h"

registerMooseObject("PhaseFieldApp", ACInterfaceBounded);

template <>
InputParameters
validParams<ACInterfaceBounded>()
{
  InputParameters params = validParams<Kernel>();
  params.addClassDescription("Gradient energy Allen-Cahn Kernel with a bounded order parameter");
...
ACInterfaceBounded::ACInterfaceBounded(const InputParameters & parameters)
...
void
ACInterfaceBounded::initialSetup()
{
...
RealGradient
ACInterfaceBounded::kappaNablaLPsi()
{
  return _kappa[_qp] * nablaLPsi();
}

Real
ACInterfaceBounded::computeQpResidual()
{
...
Real
ACInterfaceBounded::computeQpJacobian()
{
...
Real
ACInterfaceBounded::computeQpOffDiagJacobian(unsigned int jvar)
{
